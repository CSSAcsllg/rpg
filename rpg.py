...
EVENT_FLY = pygame.USEREVENT + 5  # fly animation
EVENT_EVIL_GENERATION = pygame.USEREVENT + 6
...
run_ani_R = [pygame.image.load("Images/Player/Player_Sprite_R.png"),
             pygame.image.load("Images/Player/Player_Sprite2_R.png"),
             pygame.image.load("Images/Player/Player_Sprite3_R.png"),
             pygame.image.load("Images/Player/Player_Sprite4_R.png"),
             pygame.image.load("Images/Player/Player_Sprite5_R.png"),
             pygame.image.load("Images/Player/Player_Sprite6_R.png"),
             pygame.image.load("Images/Player/Player_Sprite_R.png")]

# Run animation for the LEFT
run_ani_L = [pygame.image.load("Images/Player/Player_Sprite_L.png"),
             pygame.image.load("Images/Player/Player_Sprite2_L.png"),
             pygame.image.load("Images/Player/Player_Sprite3_L.png"),
             pygame.image.load("Images/Player/Player_Sprite4_L.png"),
             pygame.image.load("Images/Player/Player_Sprite5_L.png"),
             pygame.image.load("Images/Player/Player_Sprite6_L.png"),
             pygame.image.load("Images/Player/Player_Sprite_L.png")]

# Attack animation for the RIGHT
attack_ani_R = [pygame.image.load("Images/Player/Player_Sprite_R.png"),
                pygame.image.load("Images/Player/Player_Attack_R.png"),
                pygame.image.load("Images/Player/Player_Attack2_R.png"),
                pygame.image.load("Images/Player/Player_Attack2_R.png"),
                pygame.image.load("Images/Player/Player_Attack3_R.png"),
                pygame.image.load("Images/Player/Player_Attack3_R.png"),
                pygame.image.load("Images/Player/Player_Attack4_R.png"),
                pygame.image.load("Images/Player/Player_Attack4_R.png"),
                pygame.image.load("Images/Player/Player_Attack5_R.png"),
                pygame.image.load("Images/Player/Player_Attack5_R.png"),
                pygame.image.load("Images/Player/Player_Sprite_R.png")]

# Attack animation for the LEFT
attack_ani_L = [pygame.image.load("Images/Player/Player_Sprite_L.png"),
                pygame.image.load("Images/Player/Player_Attack_L.png"),
                pygame.image.load("Images/Player/Player_Attack2_L.png"),
                pygame.image.load("Images/Player/Player_Attack2_L.png"),
                pygame.image.load("Images/Player/Player_Attack3_L.png"),
                pygame.image.load("Images/Player/Player_Attack3_L.png"),
                pygame.image.load("Images/Player/Player_Attack4_L.png"),
                pygame.image.load("Images/Player/Player_Attack4_L.png"),
                pygame.image.load("Images/Player/Player_Attack5_L.png"),
                pygame.image.load("Images/Player/Player_Attack5_L.png"),
                pygame.image.load("Images/Player/Player_Sprite_L.png")]

# Animations for the Health Bar
health_ani = [pygame.image.load("Images/heart/heart0.png"),
              pygame.image.load("Images/heart/heart.png"),
              pygame.image.load("Images/heart/heart2.png"),
              pygame.image.load("Images/heart/heart3.png"),
              pygame.image.load("Images/heart/heart4.png"),
              pygame.image.load("Images/heart/heart5.png")]

flying_evil_ani = [pygame.image.load('Images/Items/flying_evil0.png'),
                   pygame.image.load('Images/Items/flying_evil1.png'),
                   pygame.image.load('Images/Items/flying_evil2.png'),
                   pygame.image.load('Images/Items/flying_evil3.png')]
...
class Item(pygame.sprite.Sprite):
    def __init__(self, itemtype):
        super().__init__()
        if itemtype == 1:
            self.image = pygame.image.load("Images/heart/heart.png")
        elif itemtype == 2:
...
class FlyingEvil(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Images/Items/flying_evil0.png')
        self.rect = self.image.get_rect()
        self.pos = vec(650, 150)
        self.vel = vec(0, 0)
        self.vel.x = random.randint(4, 6) / 2
        self.fly_frame = 0

        self.mana = random.randint(3, 6)
        self.exp = 2

        pygame.time.set_timer(EVENT_FLY, 200)

    def fly(self):
        if self.fly_frame >= 3:
            self.fly_frame = 0
        self.image = flying_evil_ani[self.fly_frame]
        self.fly_frame += 1
    ...
    def update(self):
        ...
        if hits and player.attacking == True:
            ...
            self.kill()
            handler.dead_evil_count += 1

            if player.mana < 30: player.mana += self.mana  # Release mana
            player.experiance += self.exp  # Release expeiriance

            rand_num = numpy.random.uniform(0, 100)
            item_no = 0
            if rand_num >= 0 and rand_num <= 10:
                item_no = 1
            elif rand_num > 10 and rand_num <= 30:
                item_no = 2
...
class EventHandler(object):
    def __init__(self):
        ...
        self.stage_enemies = []
        self.stage_flying_evils = []
        for x in range(1, 11):
            self.stage_enemies.append(int((x ** 2 / 2) + 1))
        for x in range(1,11):
            self.stage_flying_evils.append(int(2 * x / 3))
    ...
    def to_world(self):
        ...
        pygame.time.set_timer(EVENT_EVIL_GENERATION,
                              (3 - self.world) * (self.world - 1) * 2000)
        button.imgdisp = 1
        castle.hide = True
        trader.hide = True
        self.battle = True
    ...
    def world2(self):
        ...
        trader.hide = True
        for x in range(1,11):
            self.stage_flying_evils[x - 1] = int(2 * x / 3)
        pygame.time.set_timer(self.enemy_generation, 1500)
        pygame.time.set_timer(EVENT_EVIL_GENERATION, 2000)
        self.world = 2
    ...
    def update(self):
        if self.dead_enemy_count == self.stage_enemies[self.stage - 1] \
                and self.dead_evil_count == self.stage_flying_evils[self.stage - 1]:
            self.dead_enemy_count = 0
            self.dead_evil_count = 0
    ...
    def home(self):
        ...
        pygame.time.set_timer(EVENT_EVIL_GENERATION, 0)
        self.battle = False

        # Destroy any enemies or items lying around
        for group in Enemies, Items, FlyingEvils:
            for entity in group:
                entity.kill()
...
FlyingEvils = pygame.sprite.Group()
FlyingEvils.add()
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == EVENT_EVIL_GENERATION and cursor.wait == 0:
            if handler.evil_count < handler.stage_flying_evils[handler.stage - 1]:
                flying_evil = FlyingEvil()
                FlyingEvils.add(flying_evil)
                handler.evil_count += 1
        ...
        if event.type == pygame.KEYDOWN and cursor.wait == 0:
            if event.key == pygame.K_n:
                if handler.battle == True and len(Enemies) == 0 \
                        and len(FlyingEvils) == 0 and handler.next == True:
                    handler.next_stage()
                    stage_display = StageDisplay()
